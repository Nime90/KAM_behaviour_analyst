best_practices_core_competences = ''' 
KAM Core Competencies: 
1. Setting Goals and Planning Coach Growth Journey
...
2. KPI and Metrics Understanding
...
7. Proactivity and Accountability
...
8. Alignment and Expectation Setting
...
10. Inspire, Challenge, and Motivate
...
'''
best_practices_content_Monthly = ''' 
Strategic Content Expectations:
Talking Points - Monthly Meeting:
1.Monthly review:
1.1 Mention at least 3 KPIs
1.2 Mention those KPIs’ progress compared to last month
2. Social media review: 
2.1 Define top post(s)
2.2 Talk about why it/they made it top
3. Growth team updates: 
3.1 Inbound Sales (only if has_telesales=TRUE)
3.2 Performance Marketing (only if has_marketing=TRUE)
3.3 Web Performance (only if has_web-designer=TRUE)
4. Next month’s forecast and action items: 
4.1 Define next month’s KPI target - at least 1
4.2 Define clear action items - at least 2
5. Product updates:
5.1 Mention at least 1 new development and its benefits
6. Summary:
6.1 Mention of KAM (the presenter’s) Action Item(s)
6.2 Mention of Coach Action Item(s)
'''
best_practices_content_Weekly = '''
Talking Points - Weekly Meeting

1. Targets & Actions:
1.1 This Month’s Goal - reiterate this month’s primary goal
1.2 Provide an update on this week’s target(s) and progress so far
2. Check-in: Review Action Items:
2.1 Follow-up on monthly action item(s)
2.2 Add an action item for the current week specifically
3. Social Media Review
3.1 Define top post(s)
3.2 Talk about why they made it top
4. Summary
4.1 Mention of KAM (the presenter’s) Action Item(s)
4.2 Mention of Coach Action Item(s)
'''

Behavioural_Expectations= '''
Kam needs to follow these Behavioural Expectations:
1. Convincing / confident
2. Own the conversation and agenda
3. Genuinely interested in the coach and his or her well-being
4. Friendly
5. Encouraging
6. Professional / authentic as a trusted business advisor
'''